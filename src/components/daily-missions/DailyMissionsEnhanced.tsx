...
import { useDailyMissionsEnhanced } from '@/hooks/useDailyMissionsEnhanced';
import { getSectionTitleEnhanced } from '@/data/daily-questions-enhanced';
import { DailyQuestion } from '@/types/daily-missions';

interface DailyMissionsEnhancedProps {
  user: User | null;
}

export const DailyMissionsEnhanced: React.FC<DailyMissionsEnhancedProps> = ({ user }) => {
  const {
    currentQuestion,
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <div className="bg-blue-50 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-semibold text-blue-800">Água</span>
                </div>
                <p className="text-sm text-blue-700">
                  {answers['water_intake_morning'] || 'Não registrado'}
                </p>
              </div>
              ...
              <div className="bg-purple-50 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-semibold text-purple-800">Sono</span>
                </div>
        ...
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Badge variant="outline" className="text-xs">
              {getSectionTitleEnhanced(currentQuestion.section)}
            </Badge>
