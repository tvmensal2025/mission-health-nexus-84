    ...
    <Card className={`bg-black text-white border-gray-800 ${className}`}>
      ...
      <CardContent className="p-6">
        <div className="relative flex justify-center items-center">
          ...
          <div className="absolute right-0 top-0 space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">Gordura: {data.gordura.toFixed(1)}%</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 bg-green-500 rounded-full"></div>
              <span className="text-sm">Músculo: {data.musculo.toFixed(1)}%</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 bg-blue-500 rounded-full"></div>
              <span className="text-sm">Água: {data.agua.toFixed(1)}%</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 bg-purple-500 rounded-full"></div>
              <span className="text-sm">Osso: {data.osso.toFixed(1)}%</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-4 grid grid-cols-2 gap-4 text-center">
          <div>
            <div className="text-yellow-400 text-sm">Gordura Corporal</div>
            <div className="text-white text-lg font-bold">{data.gordura.toFixed(1)}%</div>
          </div>
          <div>
            <div className="text-green-400 text-sm">Massa Muscular</div>
            <div className="text-white text-lg font-bold">{data.musculo.toFixed(1)}%</div>
          </div>
          <div>
            <div className="text-blue-400 text-sm">Água Corporal</div>
            <div className="text-white text-lg font-bold">{data.agua.toFixed(1)}%</div>
          </div>
          <div>
            <div className="text-purple-400 text-sm">Massa Óssea</div>
            <div className="text-white text-lg font-bold">{data.osso.toFixed(1)}%</div>
          </div>
        </div>
      </CardContent>
    </Card>
