...
const menuItems = [
  ...
  { id: 'inicio', label: 'Missão do Dia', icon: Zap, path: '/app/missions', highlight: true },
  { id: 'plataforma-sonhos', label: 'Plataforma dos Sonhos', icon: GraduationCap, path: '/app/courses' },
  { id: 'sessoes', label: 'Sessões', icon: FileText, path: '/app/sessions' },
  { id: 'ranking', label: 'Ranking', icon: Trophy, path: '/app/ranking' },
  { id: 'avaliacoes', label: 'Avaliações', icon: ClipboardList, path: '/app/assessments' },
  { id: 'semanal', label: '📊 Semanal', icon: Calendar, path: '/app/weekly', highlight: true },
  { id: 'avaliacao-semanal', label: 'Avaliação Semanal', icon: Calendar, path: '/app/weekly-assessment' },
  { id: 'metas', label: 'Minhas Metas', icon: Target, path: '/app/goals' },
  { id: 'desafios', label: 'Desafios', icon: Award, path: '/challenges' },
  { id: 'diario', label: 'Diário de Saúde', icon: FileText, path: '/app/diary' },
  { id: 'teste-sabotadores', label: 'Teste de Sabotadores', icon: Settings, path: '/app/saboteur-test' },
  { id: 'meu-progresso', label: 'Meu Progresso', icon: BarChart3, path: '/app/progress' },
  { id: 'analise-avancada', label: 'Análise Avançada', icon: BarChart3, path: '/app/analytics' },
  { id: 'google-fit', label: 'Google Fit', icon: Activity, path: '/app/google-fit' },
  { id: 'openScale-test', label: 'Teste Xiaomi Mi Body Scale 2', icon: Scale, path: '/app/scale-test' },
  { id: 'assinaturas', label: 'Assinaturas', icon: CreditCard, path: '/app/subscriptions' },
  { id: 'apps', label: 'Apps', icon: Grid, path: '/app/apps' },
  { id: 'ajuda', label: 'Ajuda', icon: HelpCircle, path: '/app/help' }
];
